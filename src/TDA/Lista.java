...
public class Lista<T> {
    ...
    public Lista<Interno> obtenerListaInternos() {
        Lista<Interno> listaInternos = new Lista<>();
        Nodo<T> aux = cabeza;

        while (aux != null) {
            if (aux.getElemento() instanceof Interno) {
                listaInternos.agregar((Interno) aux.getElemento());
            }
            aux = aux.getSgteNodo();
        }
        ...
        public Lista<Externo> obtenerListaExternos() {
        Lista<Externo> listaExternos = new Lista<>();
        Nodo<T> aux = cabeza;

        while (aux != null) {
            if (aux.getElemento() instanceof Externo) {
                listaExternos.agregar((Externo) aux.getElemento());
            }
            aux = aux.getSgteNodo();
        }
    ...
    public Lista<Dependencia> obtenerListaDependencias() {
        Lista<Dependencia> listaDependencias = new Lista<>();
        Nodo<T> aux = cabeza;

        while (aux != null) {
            if (aux.getElemento() instanceof Dependencia) {
                listaDependencias.agregar((Dependencia) aux.getElemento());
            }
            aux = aux.getSgteNodo();
        }
    ...
    public void eliminarPorDni(String dni) {
        ...
        while (aux != null) {
            ...
            String elementoDni = null;
            if (elemento instanceof Interno) {
                elementoDni = ((Interno) elemento).getDni();
            } else if (elemento instanceof Externo) {
                elementoDni = ((Externo) elemento).getDni();
            }
            if (elementoDni != null && elementoDni.equals(dni)) {
                if (anterior == null) {
                    cabeza = aux.getSgteNodo();
                } else {
                    anterior.setSgteNodo(aux.getSgteNodo());
                }
                if (aux == ultimo) {
                    ultimo = anterior;
                }
        ...
        while (aux != null) {
            T elemento = aux.getElemento();
            String elementoNombre = null;
            if (elemento instanceof Dependencia) {
                elementoNombre = ((Dependencia) elemento).getNombre();
            }
            if (elementoNombre != null && elementoNombre.equals(nombre)) {
                if (anterior == null) {
                    cabeza = aux.getSgteNodo();
                } else {
                    anterior.setSgteNodo(aux.getSgteNodo());
